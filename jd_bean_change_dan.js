...
[task_local]
#京东日资产变动通知
20 9 * * * jd_bean_change_dan.js, tag=京东日资产变动通知, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
 * */
const $ = new Env("京东日资产变动dancer");
